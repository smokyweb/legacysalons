...
.fl-node-<?php echo $id; ?> .fl-module-content .bc-product-review-form__title {
	color: <?php echo FLBuilderColor::hex_or_rgb( $settings->bc_review_form_title_color ); ?>;
}
<?php endif; ?>
...
.fl-node-<?php echo $id; ?> .fl-module-content .bc-product-reviews__title {
	<?php printf( 'color: %s;', FLBuilderColor::hex_or_rgb( $settings->bc_reviews_title_color ) ); ?>
}
<?php endif; ?>
...
if ( ! empty( $settings->bc_review_form_submit_button_background_color ) ) {
	printf( 'background-color: %s;', FLBuilderColor::hex_or_rgb( $settings->bc_review_form_submit_button_background_color ) );
}

if ( ! empty( $settings->bc_review_form_submit_button_text_color ) ) {
	printf( 'color: %s;', FLBuilderColor::hex_or_rgb( $settings->bc_review_form_submit_button_text_color ) );
}
