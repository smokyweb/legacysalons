...
.fl-node-<?php echo $id; ?> #tribe-events .tribe-events-ical.tribe-events-button {
	color: <?php echo FLBuilderColor::hex_or_rgb( $settings->fg_color ); ?>;
}
.fl-node-<?php echo $id; ?> #tribe-events-bar input,
...
.fl-node-<?php echo $id; ?> .tribe-grid-body .tribe-event-featured.tribe-events-week-hourly-single,
.fl-node-<?php echo $id; ?> .tribe-events-list .tribe-events-event-cost span {
	border-color: <?php echo FLBuilderColor::hex_or_rgb( $settings->bg_color ); ?>;
}
.fl-node-<?php echo $id; ?> .tribe-grid-body .tribe-event-featured.tribe-events-week-hourly-single {
...
.fl-node-<?php echo $id; ?> .tribe-events-grid .tribe-grid-header .tribe-week-today {
	background-color: <?php echo FLBuilderColor::hex_or_rgb( FLBuilderColor::adjust_brightness( $settings->bg_color, 25, 'darken' ) ); ?>;
}
...
.fl-node-<?php echo $id; ?> .tribe-events-notices {
	color: <?php echo FLBuilderColor::hex_or_rgb( $settings->notice_text_color ); ?>;
	text-shadow:none;
}
<?php endif; ?>
...
.fl-node-<?php echo $id; ?> .tribe-events-notices {
	background-color: <?php echo FLBuilderColor::hex_or_rgb( $settings->notice_bg_color ); ?>;
	border-color: <?php echo FLBuilderColor::hex_or_rgb( FLBuilderColor::adjust_brightness( $settings->notice_bg_color, 25, 'darken' ) ); ?>;
}
<?php endif; ?>
