...
.fl-node-<?php echo $id; ?> .tribe-common .tribe-tickets__footer {
	border-top: 1px solid <?php echo FLBuilderColor::hex_or_rgb( $settings->sep_color ); ?>;
}
<?php endif; ?>
...
.fl-node-<?php echo $id; ?> button.tribe-button {
	...
	border: 1px solid <?php echo FLBuilderColor::hex_or_rgb( FLBuilderColor::adjust_brightness( $settings->btn_bg_color, 12, 'darken' ) ); ?>
}
<?php endif; ?>
...
.fl-node-<?php echo $id; ?> .tribe-common .tribe-tickets__footer button[disabled=disabled] {
	background-color: <?php echo FLBuilderColor::hex_or_rgb( $settings->disabled_btn_bg_color ); ?>;
	border: 1px solid <?php echo FLBuilderColor::hex_or_rgb( FLBuilderColor::adjust_brightness( $settings->disabled_btn_bg_color, 12, 'darken' ) ); ?>
}
<?php endif; ?>

<?php if ( ! empty( $settings->disabled_btn_text_color ) ) : ?>
.fl-node-<?php echo $id; ?> .tribe-common .tribe-tickets__footer button[disabled=disabled] {
	color: <?php echo FLBuilderColor::hex_or_rgb( $settings->disabled_btn_text_color ); ?>;
}
<?php endif; ?>
