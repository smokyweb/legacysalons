	...
	class SPFTESTIMONIAL_Metabox extends SPFTESTIMONIAL_Abstract {
		...
		public function add_meta_box_content( $post, $callback ) {
			...
			if ( ! empty( $this->args['show_restore'] ) || ! empty( $this->args['show_reset'] ) ) {
				...
				echo '<span class="button spftestimonial-button-reset">' . esc_html__( 'Reset', 'testimonial-pro' ) . '</span>';
				echo '<span class="button spftestimonial-button-cancel">' . sprintf( '<small>( %s )</small> %s', esc_html__( 'update post', 'testimonial-pro' ), esc_html__( 'Cancel', 'testimonial-pro' ) ) . '</span>';
				echo '</label>';
				echo '</div>';
