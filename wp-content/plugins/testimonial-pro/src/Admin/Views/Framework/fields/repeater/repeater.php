	...
	class SPFTESTIMONIAL_Field_repeater extends SPFTESTIMONIAL_Fields {
		...
		public function render() {
			...
			if ( preg_match( '/' . preg_quote( '[' . $this->field['id'] . ']' ) . '/', $this->unique ) ) {
				...
				echo '<div class="spftestimonial-notice spftestimonial-notice-danger">' . esc_html__( 'Error: Field ID conflict.', 'testimonial-pro' ) . '</div>';
				...
				echo '<div class="spftestimonial-repeater-alert spftestimonial-repeater-max">' . esc_html__( 'You cannot add more.', 'testimonial-pro' ) . '</div>';
				echo '<div class="spftestimonial-repeater-alert spftestimonial-repeater-min">' . esc_html__( 'You cannot remove more.', 'testimonial-pro' ) . '</div>';
