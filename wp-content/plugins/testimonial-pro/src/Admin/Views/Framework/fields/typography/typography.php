...
if ( ! class_exists( 'SPFTESTIMONIAL_Field_typography' ) ) {
	/**
	 * SPFTESTIMONIAL_Field_typography
	 */
	class SPFTESTIMONIAL_Field_typography extends SPFTESTIMONIAL_Fields {
		...
		public function render() {
			...
			if ( ! empty( $args['font_family'] ) ) {
				...
				echo $this->create_select( array( $this->value['font-family'] => $this->value['font-family'] ), 'font-family', esc_html__( 'Select a font', 'testimonial-pro' ) );// phpcs:ignore
				echo '</div>';
			}
			...
			if ( ! empty( $args['backup_font_family'] ) ) {
				...
				echo $this->create_select(
					...
					'backup-font-family',
					esc_html__( 'Default', 'testimonial-pro' )
				);
				echo '</div>';
			}
			...
			if ( ! empty( $args['font_weight'] ) || ! empty( $args['font_style'] ) ) {
				...
				echo '<option value="">' . ( ! $this->chosen ? esc_html__( 'Default', 'testimonial-pro' ) : '' ) . '</option>';// phpcs:ignore
			...
			if ( ! empty( $args['subset'] ) ) {
				...
				echo $this->create_select( $subset, 'subset', esc_html__( 'Default', 'testimonial-pro' ), $args['multi_subset'] );// phpcs:ignore
				echo '</div>';
			}
		 ...
		 * @param  mixed $is_multiple is multiple.
		 * @return statement
		 */
