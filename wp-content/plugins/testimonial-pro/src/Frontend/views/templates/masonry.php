 ...
 * Masonry layout.
 *
 * This template can be overridden by copying it to yourtheme/testimonial-pro/templates/masonry.php
 *
...
?>
<div id="sp-testimonial-pro-<?php echo esc_attr( $post_id ); ?>" <?php echo wp_kses_post( $the_rtl ) . ' ' . wp_kses_post( $data_attr ); ?> class="sp-testimonial-pro-section <?php echo esc_attr( $pagination_type ) . ' tpro-layout-masonry-' . esc_attr( $slider_mode ) . ' sp-testimonial-pro-read-more tpro-readmore-' . esc_attr( $testimonial_read_more_link_action ) . '-' . esc_attr( $testimonial_read_more_class ) . ' tpro-style-' . esc_attr( $theme_style ); ?> sp_testimonial_pro_masonry">
