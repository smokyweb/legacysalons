 ...
 * Theme eight.
 *
 * This template can be overridden by copying it to yourtheme/testimonial-pro/templates/theme/theme-eight.php
 *
...
if ( 'right' === $testimonial_info_position || 'bottom' === $testimonial_info_position ) {
...
if ( 'left' === $testimonial_info_position || 'top' === $testimonial_info_position ) {
	echo '<div class="tpro-testimonial-content-area">';
	if ( $show_testimonial_client_rating && '' !== $tpro_rating_star && 'above_title' === $rating_star_position ) { // Rating before title.
		include self::sptp_locate_template( 'testimonial/rating.php' );
	}
