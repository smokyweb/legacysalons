 ...
 * Theme five.
 *
 * This template can be overridden by copying it to yourtheme/testimonial-pro/templates/theme/theme-five.php
 *
 * @package    Testimonial_Pro
 * @subpackage Testimonial_Pro/Frontend
 */

if ( $show_client_image && 'bottom' !== $client_image_position_two ) {
