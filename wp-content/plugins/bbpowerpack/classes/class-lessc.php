...
class powerpack_lessc {
    ...
    protected function injectVariables($args) {
        $this->pushEnv();
        $parser = new powerpack_lessc_parser($this, __METHOD__);
    ...
    protected function makeParser($name) {
        $parser = new powerpack_lessc_parser($this, $name);
    ...
    protected function newFormatter() {
        $className = "powerpack_lessc_formatter_lessjs";
        if (!empty($this->formatterName)) {
            if (!is_string($this->formatterName))
                return $this->formatterName;
            $className = "powerpack_lessc_formatter_$this->formatterName";
        }
...
class powerpack_lessc_parser {
    ...
    public function __construct($lessc, $sourceName = null) {
        ...
        if (!self::$operatorString) {
            self::$operatorString =
                '('.implode('|', array_map(array('powerpack_lessc', 'preg_quote'),
                    array_keys(self::$precedence))).')';

            $commentSingle = powerpack_lessc::preg_quote(self::$commentSingle);
            $commentMultiLeft = powerpack_lessc::preg_quote(self::$commentMultiLeft);
            $commentMultiRight = powerpack_lessc::preg_quote(self::$commentMultiRight);
    ...
    protected function isDirective($dirname, $directives) {
        ...
        $pattern = implode("|",
            array_map(array("powerpack_lessc", "preg_quote"), $directives));
    ...
    protected function expressionList(&$exps) {
        ...
        $exps = powerpack_lessc::compressList($values, ' ');
        return true;
    }
    ...
    public function propertyValue(&$value, $keyName = null) {
        ...
        $value = powerpack_lessc::compressList($values, ', ');
        return true;
    }
    ...
    protected function openString($end, &$out, $nestingOpen=null, $rejectStrs = null) {
        ...
        $stop = array("'", '"', "@{", $end);
        $stop = array_map(array("powerpack_lessc", "preg_quote"), $stop);
    ...
    protected function string(&$out) {
        ...
        $patt = '([^\n]*?)(@\{|\\\\|' .
            powerpack_lessc::preg_quote($delim).')';
    ...
    protected function literal($what, $eatWhitespace = null) {
        ...
        if (!isset(self::$literalCache[$what])) {
            self::$literalCache[$what] = powerpack_lessc::preg_quote($what);
        }
    ...
    protected function to($what, &$out, $until = false, $allowNewline = false) {
        ...
        if (!$this->match('('.$validChars.'*?)'.powerpack_lessc::preg_quote($what), $m, !$until)) return false;
...
class powerpack_lessc_formatter_classic {
    public $indentChar = "  ";
...
class powerpack_lessc_formatter_compressed extends powerpack_lessc_formatter_classic {
...
class powerpack_lessc_formatter_lessjs extends powerpack_lessc_formatter_classic {
    public $disableSingle = true;
