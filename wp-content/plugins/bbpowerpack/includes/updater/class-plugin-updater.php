...
class PP_Plugin_Updater {
	...
	public function show_changelog() {
		...
		if ( ! current_user_can( 'update_plugins' ) ) {
			wp_die( esc_html__( 'You do not have permission to install plugin updates', 'bb-powerpack' ), esc_html__( 'Error', 'bb-powerpack' ), array( 'response' => 403 ) );
		}
	...
	private function verify_ssl() {
		return (bool) apply_filters( 'pp_updater_sl_api_request_verify_ssl', true, $this );
	}
