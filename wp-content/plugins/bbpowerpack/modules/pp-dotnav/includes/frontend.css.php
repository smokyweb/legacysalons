...
.fl-node-<?php echo $id; ?> .pp-dotnav .pp-dot a .pp-dot-circle {
    ...
    border-color: <?php echo $settings->dot_border_color ? pp_get_color_value( $settings->dot_border_color ) : 'transparent'; ?>;
    border-style: solid;
    border-radius: 100%;
    position: relative;
    top: 5px;
...
.fl-node-<?php echo $id; ?> .pp-dotnav .pp-dot a:hover .pp-dot-circle {
	...
	<?php } ?>
    border-color: <?php echo $settings->dot_border_color_hover ? pp_get_color_value( $settings->dot_border_color_hover ) : 'transparent'; ?>;
    -webkit-transition: all 0.3s ease;
    -moz-transition: all 0.3s ease;
    -ms-transition: all 0.3s ease;
    transition: all 0.3s ease;
...
.fl-node-<?php echo $id; ?> .pp-dotnav .pp-dot.active .pp-dot-circle {
	...
	<?php } ?>
    border-color: <?php echo $settings->dot_border_color_active ? pp_get_color_value( $settings->dot_border_color_active ) : 'transparent'; ?>;
}
.fl-node-<?php echo $id; ?> .pp-dotnav .pp-dot .pp-label {
	...
	<?php } ?>
    color: <?php echo pp_get_color_value( $settings->dot_label_text ? $settings->dot_label_text : 'ffffff' ); ?>;
    border-radius: 2px;
    font-size: 13px;
    line-height: 1;
...
.fl-node-<?php echo $id; ?> .pp-dotnav .pp-dot .pp-label:after {
    ...
    border-<?php echo ('right' == $settings->dot_position) ? 'left' : 'right'; ?>: 5px solid <?php echo $settings->dot_label_color ? pp_get_color_value( $settings->dot_label_color ) : 'transparent'; ?>;
    margin-top: -5px;
    position: absolute;
    top: 50%;
