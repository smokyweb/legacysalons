		...
		<div class="pp-line-separator-inner pp-icon-image">
			<?php if( $settings->icon_image_select == 'icon' ) { ?>
				<div class="pp-line-separator pp-icon-wrap">
					<span class="pp-icon <?php echo esc_attr( $settings->separator_icon ); ?>"></span>
				</div>
			<?php } else { ?>
				<div class="pp-line-separator pp-image-wrap">
					<img class="pp-icon-image pp-type-<?php echo esc_attr( $settings->icon_image_select ); ?>" src="<?php echo wp_get_attachment_url( absint($settings->separator_image) ); ?>" alt="<?php echo pp_get_image_alt($settings->separator_image); ?>" />
				</div>
			<?php } ?>
		</div>
	<?php } ?>
