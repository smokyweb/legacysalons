...
.fl-node-<?php echo $id; ?> .pp-advanced-menu .pp-menu-overlay {
	<?php $overlay_opacity = $settings->responsive_overlay_bg_opacity ? $settings->responsive_overlay_bg_opacity : 100; ?>
	background-color: <?php echo ( $settings->responsive_overlay_bg_color ) ? pp_hex2rgba(pp_get_color_value( $settings->responsive_overlay_bg_color ), ($overlay_opacity / 100)) : 'rgba(0,0,0,0.8)'; ?>;
}
...
FLBuilderCSS::dimension_field_rule( array(
	...
	'selector' 		=> ".fl-node-$id .pp-advanced-menu.full-screen .menu li a, .fl-node-$id .pp-advanced-menu.full-screen .menu li .pp-has-submenu-container a",
	'unit'			=> 'px',
	'props'			=> array(
...
.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .menu li .pp-has-submenu-container a:focus {
	<?php if ( $settings->responsive_link_bg_hover_color ) { ?>
		background-color: <?php echo pp_get_color_value( $settings->responsive_link_bg_hover_color ); ?>;
	<?php } ?>
	<?php if ( $settings->responsive_link_hover_color ) { ?>
		color: <?php echo pp_get_color_value( $settings->responsive_link_hover_color ); ?>;
	<?php } ?>
}
...
<?php if ( ! empty( $settings->responsive_link_hover_color ) ) { ?>
		...
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-arrows li a:hover .pp-menu-toggle:before,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-none li a:hover .pp-menu-toggle:before,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-arrows li a:focus .pp-menu-toggle:before,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-none li a:focus .pp-menu-toggle:before,
		...
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-arrows .sub-menu li a:hover .pp-menu-toggle:before,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-none .sub-menu li a:hover .pp-menu-toggle:before,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-arrows .sub-menu li a:focus .pp-menu-toggle:before,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-none .sub-menu li a:focus .pp-menu-toggle:before,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-arrows .pp-has-submenu-container.focus .pp-menu-toggle:before,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-arrows li.pp-active > .pp-has-submenu-container .pp-menu-toggle:before,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .menu li a:focus .pp-menu-toggle:before {
		...
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-plus li a:hover .pp-menu-toggle:before,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-plus li a:hover .pp-menu-toggle:after,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-plus li a:focus .pp-menu-toggle:before,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-plus li a:focus .pp-menu-toggle:after,
		...
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-plus .sub-menu li a:hover .pp-menu-toggle:before,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-plus .sub-menu li a:hover .pp-menu-toggle:after,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-plus .sub-menu li a:focus .pp-menu-toggle:before,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-plus .sub-menu li a:focus .pp-menu-toggle:after,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-plus .pp-has-submenu-container.focus .pp-menu-toggle:before,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-plus .pp-has-submenu-container.focus .pp-menu-toggle:after,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-plus li.pp-active > .pp-has-submenu-container .pp-menu-toggle:before,
		.fl-node-<?php echo $id; ?> .pp-advanced-menu.full-screen .pp-toggle-plus li.pp-active > .pp-has-submenu-container .pp-menu-toggle:after {
			border-color: <?php echo pp_get_color_value( $settings->responsive_link_hover_color ); ?>;
		}
		<?php } ?>
<?php } ?>
