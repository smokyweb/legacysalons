...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-field {
    <?php if( $settings->input_field_margin >= 0 ) { ?>
	margin-bottom: <?php echo $settings->input_field_margin; ?>px;
    <?php } ?>
}

.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-form .wpforms-title,
...
<?php
	...
	FLBuilderCSS::typography_field_rule( array(
		...
		'selector' 		=> ".fl-node-$id .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-title, .fl-node-$id .pp-wpforms-content .wpforms-container .pp-form-title",
	) );
?>
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-title {
	<?php if( $settings->form_custom_title_desc == 'yes' ) { ?>
	display: none;
	<?php } ?>
}

.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-description,
...
<?php
	...
	FLBuilderCSS::typography_field_rule( array(
		...
		'selector' 		=> ".fl-node-$id .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-description, .fl-node-$id .pp-wpforms-content .pp-form-description",
	) );
?>
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-field-label {
...
<?php
	...
	FLBuilderCSS::typography_field_rule( array(
		...
		'selector' 		=> ".fl-node-$id .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-field-label",
	) );
	...
	FLBuilderCSS::typography_field_rule( array(
		...
		'selector' 		=> ".fl-node-$id .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-field-radio .wpforms-field-label-inline, .fl-node-$id .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-field-checkbox .wpforms-field-label-inline",
	) );
?>

.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-field-sublabel,
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-field-label-inline {
    <?php if ( $settings->form_label_color ) { ?>
    color: <?php echo pp_get_color_value( $settings->form_label_color ); ?>;
    <?php } ?>
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-field-description {
...
<?php
	...
	FLBuilderCSS::responsive_rule( array(
		...
		'selector'		=> ".fl-node-$id .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-field-description",
		'prop'			=> 'font-size',
		'unit'			=> 'px',
	) );
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form input:not([type='radio']):not([type='checkbox']):not([type='submit']):not([type='button']):not([type='image']):not([type='file']),
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form select,
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form textarea {
...
<?php
	...
	FLBuilderCSS::typography_field_rule( array(
		...
		'selector' 		=> ".fl-node-$id .pp-wpforms-content .wpforms-container .wpforms-form input:not([type='radio']):not([type='checkbox']):not([type='submit']):not([type='button']):not([type='image']):not([type='file']), .fl-node-$id .pp-wpforms-content .wpforms-container .wpforms-form select, .fl-node-$id .pp-wpforms-content .wpforms-container .wpforms-form textarea",
	) );
...
<?php if ( isset( $settings->input_field_padding_left ) && '' !== $settings->input_field_padding_left ) { ?>
	.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-field-phone .iti__flag-container + input[type=tel] {
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-field-row input,
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-field-row select,
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-field-row textarea {
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form input:not([type='radio']):not([type='checkbox']):not([type='submit']):not([type='button']):not([type='image']):not([type='file'])::-webkit-input-placeholder {
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form input:not([type='radio']):not([type='checkbox']):not([type='submit']):not([type='button']):not([type='image']):not([type='file']):-moz-placeholder {
    <?php if( $settings->input_placeholder_color && $settings->input_placeholder_display == 'block' ) { ?>
    color: <?php echo pp_get_color_value( $settings->input_placeholder_color ); ?>;
    <?php } else { ?>
    color: transparent;
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form input:not([type='radio']):not([type='checkbox']):not([type='submit']):not([type='button']):not([type='image']):not([type='file']):-ms-input-placeholder {
    <?php if( $settings->input_placeholder_color && $settings->input_placeholder_display == 'block' ) { ?>
    color: <?php echo pp_get_color_value( $settings->input_placeholder_color ); ?>;
    <?php } else { ?>
    color: transparent;
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form select::-webkit-input-placeholder {
    <?php if( $settings->input_placeholder_color && $settings->input_placeholder_display == 'block' ) { ?>
    color: <?php echo pp_get_color_value( $settings->input_placeholder_color ); ?>;
    <?php } else { ?>
    color: transparent;
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form select:-moz-placeholder {
    <?php if( $settings->input_placeholder_color && $settings->input_placeholder_display == 'block' ) { ?>
    color: <?php echo pp_get_color_value( $settings->input_placeholder_color ); ?>;
    <?php } else { ?>
    color: transparent;
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form select:-ms-input-placeholder {
    <?php if( $settings->input_placeholder_color && $settings->input_placeholder_display == 'block' ) { ?>
    color: <?php echo pp_get_color_value( $settings->input_placeholder_color ); ?>;
    <?php } else { ?>
    color: transparent;
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form textarea::-webkit-input-placeholder {
    <?php if( $settings->input_placeholder_color && $settings->input_placeholder_display == 'block' ) { ?>
    color: <?php echo pp_get_color_value( $settings->input_placeholder_color ); ?>;
    <?php } else { ?>
    color: transparent;
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form textarea:-moz-placeholder {
    <?php if( $settings->input_placeholder_color && $settings->input_placeholder_display == 'block' ) { ?>
    color: <?php echo pp_get_color_value( $settings->input_placeholder_color ); ?>;
    <?php } else { ?>
    color: transparent;
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form textarea:-ms-input-placeholder {
    <?php if( $settings->input_placeholder_color && $settings->input_placeholder_display == 'block' ) { ?>
    color: <?php echo pp_get_color_value( $settings->input_placeholder_color ); ?>;
    <?php } else { ?>
    color: transparent;
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form input:not([type='radio']):not([type='checkbox']):not([type='submit']):not([type='button']):not([type='image']):not([type='file']):focus,
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form select:focus,
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form textarea:focus {
    border-color: <?php echo $settings->input_field_focus_color ? pp_get_color_value( $settings->input_field_focus_color ) : 'transparent'; ?>;
}

.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form .wpforms-submit-container {
    text-align: <?php echo $settings->button_alignment; ?>;
}

.fl-builder-content .fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form button:not(.iti__selected-country) {
...
<?php
	...
	FLBuilderCSS::border_field_rule( array(
		...
		'selector' 		=> ".fl-builder-content .fl-node-$id .pp-wpforms-content .wpforms-container .wpforms-form button:not(.iti__selected-country), .fl-builder-content .fl-node-$id .pp-wpforms-content .wpforms-container .wpforms-form button:not(.iti__selected-country):hover",
	) );
	...
	FLBuilderCSS::typography_field_rule( array(
		...
		'selector' 		=> ".fl-builder-content .fl-node-$id .pp-wpforms-content .wpforms-container .wpforms-form button:not(.iti__selected-country)",
	) );
...
.fl-builder-content .fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form button:not(.iti__selected-country):hover {
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-container .wpforms-form label.wpforms-error {
...
<?php
	...
	FLBuilderCSS::responsive_rule( array(
		...
		'selector'		=> ".fl-node-$id .pp-wpforms-content .wpforms-container .wpforms-form label.wpforms-error",
		'prop'			=> 'font-size',
		'unit'			=> 'px',
	) );
?>
...
.fl-node-<?php echo $id; ?> .pp-wpforms-content .wpforms-confirmation-container-full {
    ...
    <?php } ?>
	border-color: <?php echo $settings->success_message_border_color ? pp_get_color_value( $settings->success_message_border_color ) : 'transparent'; ?>;
