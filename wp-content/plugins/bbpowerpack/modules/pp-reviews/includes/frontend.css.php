<?php
	...
	FLBuilderCSS::responsive_rule(
		array(
			...
			'prop'         => 'height',
			'unit'         => 'px',
			'enabled'      => ! isset( $settings->auto_height ) || 'no' === $settings->auto_height
		)
	);
	...
	FLBuilderCSS::responsive_rule(
		array(
			...
			'selector'     => ".fl-node-$id .swiper-horizontal>.swiper-pagination-bullets .swiper-pagination-bullet",
			'prop'         => 'margin-left',
			'unit'         => 'px',
		)
	);
...
.fl-node-<?php echo $id; ?> .pp-review-item.swiper-slide {
	<?php
	if ( isset( $settings->auto_height ) && 'yes' === $settings->auto_height ) {
		?>
		height: max-content;
		<?php
	}
...
.fl-node-<?php echo $id; ?> .pp-swiper-button svg {
	<?php if ( isset( $settings->arrow_font_size ) && ! empty( $settings->arrow_font_size ) ) { ?>
	width: <?php echo $settings->arrow_font_size; ?>px;
