...
.fl-node-<?php echo $id; ?> .pp-flipbox-front {
	...
	<?php if( $settings->front_border_color ) { ?>border-color: <?php echo pp_get_color_value( $settings->front_border_color ); ?>;<?php } ?>
}
.fl-node-<?php echo $id; ?> .pp-flipbox-front .pp-flipbox-title .pp-flipbox-front-title {
	<?php if( $settings->front_title_color ) { ?>color: <?php echo pp_get_color_value( $settings->front_title_color ); ?>;<?php } ?>
...
.fl-node-<?php echo $id; ?> .pp-flipbox-front .pp-flipbox-description {
	<?php if( $settings->front_text_color ) { ?>color: <?php echo pp_get_color_value( $settings->front_text_color ); ?>;<?php } ?>
...
.fl-node-<?php echo $id; ?> .pp-flipbox-back {
	...
	<?php if( $settings->back_border_color ) { ?>border-color: <?php echo pp_get_color_value( $settings->back_border_color ); ?>;<?php } ?>
}
.fl-node-<?php echo $id; ?> .pp-flipbox-back .pp-flipbox-title .pp-flipbox-back-title {
	<?php if( $settings->back_title_color ) { ?>color: <?php echo pp_get_color_value( $settings->back_title_color ); ?>;<?php } ?>
...
.fl-node-<?php echo $id; ?> .pp-flipbox-back .pp-flipbox-description {
	<?php if( $settings->back_text_color ) { ?>color: <?php echo pp_get_color_value( $settings->back_text_color ); ?>;<?php } ?>
...
<?php if( $settings->icon_type == 'icon' ) { ?>
	...
	.fl-node-<?php echo $id; ?> .pp-flipbox-icon-inner {
		...
		<?php if( ( $settings->show_border == 'yes' && $settings->icon_border_radius ) || ( $settings->icon_background && $settings->icon_border_radius ) ) { ?>
			<?php if( $settings->icon_border_radius ) { ?>border-radius: <?php echo $settings->icon_border_radius; ?>px;<?php } ?>
		<?php } ?>
		<?php if( $settings->icon_color ) { ?>color: <?php echo pp_get_color_value( $settings->icon_color ); ?>;<?php } ?>
	}
	<?php
		// Icon - Font Size
	...
	.fl-node-<?php echo $id; ?> .pp-flipbox-icon-inner:hover {
		...
		<?php if( $settings->icon_color_hover ) { ?>color: <?php echo pp_get_color_value( $settings->icon_color_hover ); ?>;<?php } ?>
	}
<?php } ?>
...
<?php if( $settings->link_type == 'custom' ) { ?>
	.fl-node-<?php echo $id; ?> .pp-flipbox .pp-more-link {
		...
		<?php if( $settings->link_color ) { ?>color: <?php echo pp_get_color_value( $settings->link_color ); ?>;<?php } ?>
	}
	<?php
		// More Link - Padding
	...
	.fl-node-<?php echo $id; ?> .pp-flipbox .pp-more-link:hover {
		...
		<?php if( $settings->link_color_hover ) { ?>color: <?php echo pp_get_color_value( $settings->link_color_hover ); ?>;<?php } ?>
	}
<?php } ?>
