...
class PPHeadingModule extends FLBuilderModule {
	...
	public function __construct() {
		parent::__construct(
			array(
				...
				'description'     => __( 'A module to create headings with descriptions or dual headings.', 'bb-powerpack' ),
	...
	public function render_separator() {
		...
		if ( in_array( $settings->heading_separator, array( 'no_spacer', 'inline-prefix' ) ) ) {
			return;
		}
		?>
		...
		<?php
		if ( 'inline' === $separator ) {
			$this->render_separator_inline_only();
		}
	...
	public function render_separator_inline_only() {
		echo '<span></span>';
	}
				...
				'main_heading_style'       => array( // Section
					...
					'fields'    => array( // Section Fields
						...
						'heading_bg_hover_color' => array(
							...
							'preview'         => array(
								'type'            => 'css',
								'selector'        => '.pp-heading-content .pp-heading .heading-title:hover span.pp-primary-title',
								'property'        => 'background-color'
							)
						),
				...
				'heading2_style'	=> array( // Section
					...
					'fields'        	=> array( // Section Fields
						...
						'heading2_bg_hover_color' => array(
							...
							'preview'         => array(
								'type'            => 'css',
								'selector'        => '.pp-heading-content .pp-heading .heading-title:hover span.pp-secondary-title',
								'property'        => 'background-color'
							)
						),
