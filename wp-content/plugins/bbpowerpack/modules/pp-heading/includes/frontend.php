...
<div class="pp-heading-content">
	...
	<div class="pp-heading <?php if ( 'inline' == $settings->heading_separator ) { echo 'pp-separator--' . $settings->heading_separator; } ?> pp-<?php echo esc_attr( $settings->heading_alignment ); ?><?php echo $is_dual_heading ? ' pp-dual-heading' : ''; ?>">
		<?php if ( 'inline' == $settings->heading_separator || 'top' === $settings->heading_separator_postion || 'left' === $settings->heading_separator_postion ) {
		...
		<?php if ( 'inline' == $settings->heading_separator || 'middle' === $settings->heading_separator_postion || 'right' === $settings->heading_separator_postion ) {
