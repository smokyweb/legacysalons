...
div.fl-node-<?php echo $id; ?> .pp-heading-content .pp-heading .heading-title:hover span.pp-primary-title {
	<?php if ( isset( $settings->heading_bg_hover_color ) && ! empty( $settings->heading_bg_hover_color ) ) { ?>
		background-color: <?php echo pp_get_color_value( $settings->heading_bg_hover_color ); ?>;
	<?php } ?>
...
div.fl-node-<?php echo $id; ?> .pp-heading-content .pp-heading .heading-title span.pp-secondary-title {
	<?php if ( ! empty( $settings->heading2_color ) ) { ?>
	color: <?php echo pp_get_color_value( $settings->heading2_color ); ?>;
	<?php } ?>
	<?php if ( ! empty( $settings->heading2_bg_color ) ) { ?>
...
div.fl-node-<?php echo $id; ?> .pp-heading-content .pp-heading .heading-title:hover span.pp-secondary-title {
	<?php if ( isset( $settings->heading2_bg_hover_color ) && ! empty( $settings->heading2_bg_hover_color ) ) { ?>
		background-color: <?php echo pp_get_color_value( $settings->heading2_bg_hover_color ); ?>;
	<?php } ?>
...
div.fl-node-<?php echo $id; ?> .pp-heading-content .pp-heading.pp-separator--inline,
div.fl-node-<?php echo $id; ?> .pp-heading-content .pp-heading:not(.pp-separator--inline) .heading-title {
	<?php if ( '' !==  $settings->heading_top_margin ) { ?>
	margin-top: <?php echo $settings->heading_top_margin; ?>px;
	<?php } ?>
	<?php if ( '' !==  $settings->heading_bottom_margin ) { ?>
...
if ( 'no' == $settings->dual_heading ) {
	FLBuilderCSS::responsive_rule( array(
		'settings' => $settings,
		'setting_name' => 'font_title_line_space',
		'selector' => "div.fl-node-$id div.pp-heading-content .pp-heading.pp-separator-inline .heading-title span, div.fl-node-$id div.pp-heading-content .pp-heading.pp-separator--inline > .pp-heading-separator:last-of-type",
		'prop' => 'padding-left',
		'unit' => 'px'
	) );
	FLBuilderCSS::responsive_rule( array(
		'settings' => $settings,
		'setting_name' => 'font_title_line_space',
		'selector' => "div.fl-node-$id div.pp-heading-content .pp-heading.pp-separator-inline .heading-title span, div.fl-node-$id div.pp-heading-content .pp-heading.pp-separator--inline > .pp-heading-separator:first-of-type",
		'prop' => 'padding-right',
		'unit' => 'px'
	) );
} else {
	FLBuilderCSS::responsive_rule( array(
		'settings' => $settings,
		'setting_name' => 'font_title_line_space',
		'selector' => "div.fl-node-$id div.pp-heading-content .pp-heading.pp-separator-inline .heading-title span.pp-primary-title, div.fl-node-$id div.pp-heading-content .pp-heading.pp-separator--inline > .pp-heading-separator:last-of-type",
		'prop' => 'padding-left',
		'unit' => 'px'
	) );
	FLBuilderCSS::responsive_rule( array(
		'settings' => $settings,
		'setting_name' => 'font_title_line_space',
		'selector' => "div.fl-node-$id div.pp-heading-content .pp-heading.pp-separator-inline .heading-title span.pp-secondary-title, div.fl-node-$id div.pp-heading-content .pp-heading.pp-separator--inline > .pp-heading-separator:first-of-type",
		'prop' => 'padding-right',
		'unit' => 'px'
	) );
}
...
div.fl-node-<?php echo $id; ?> .pp-heading-content .pp-heading.pp-separator--inline .pp-heading-separator span {
	<?php if ( $settings->line_width >= 0 ) { ?>
	width: <?php echo $settings->line_width; ?><?php echo $line_width_unit; ?>;
	<?php } ?>
	<?php if ( $settings->heading_line_style ) { ?>
...
div.fl-node-<?php echo $id; ?> .pp-heading-content .pp-heading-separator:not(.inline) {
...
FLBuilderCSS::dimension_field_rule( array(
	...
	'selector' 		=> "div.fl-node-$id .pp-heading-content .pp-heading-separator:not(.inline)",
	'unit'			=> 'px',
	'props'			=> array(
