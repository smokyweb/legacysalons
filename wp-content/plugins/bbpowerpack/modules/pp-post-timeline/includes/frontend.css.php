...
.fl-node-<?php echo $id; ?> .pp-post-timeline-content-wrapper:before {
	border-right-color: <?php echo ( $settings->post_timeline_line_color ) ? pp_get_color_value( $settings->post_timeline_line_color ) : '#000'; ?>;
...
.fl-node-<?php echo $id; ?> .pp-post-timeline .pp-post-timeline-content-wrapper:after {
	border-color: <?php echo ( $settings->post_timeline_line_color ) ? pp_get_color_value( $settings->post_timeline_line_color ) : '#000'; ?>;
}
.fl-node-<?php echo $id; ?> .pp-post-timeline.horizontal .pp-post-timeline-content-wrapper:before {
	...
	border-top-color: <?php echo ( $settings->post_timeline_line_color ) ? pp_get_color_value( $settings->post_timeline_line_color ) : '#000'; ?>;
}
.fl-node-<?php echo $id; ?> .pp-post-timeline-content-wrapper .pp-post-timeline-item .pp-post-timeline-content .pp-post-timeline-title-wrapper {
	...
	<?php if( '' != $settings->title_border ) { ?>
		...
		border-bottom-color: <?php echo pp_get_color_value( $settings->title_border_color ); ?>;
...
.fl-node-<?php echo $id; ?> .pp-post-timeline-content-wrapper .pp-post-timeline-item .pp-post-timeline-content .pp-post-timeline-title {
	<?php if( $settings->title_text_color ) { ?>color: <?php echo pp_get_color_value( $settings->title_text_color ); ?>;<?php } ?>
}
...
.fl-node-<?php echo $id; ?> .pp-post-timeline-content-wrapper .pp-post-timeline-item .pp-post-timeline-content .pp-post-timeline-meta {
	<?php if ( $settings->meta_text_color ) { ?>color: <?php echo pp_get_color_value( $settings->meta_text_color ); ?>;<?php } ?>
}
<?php
	// Meta Typography
	FLBuilderCSS::typography_field_rule( array(
...
.fl-node-<?php echo $id; ?> .pp-post-timeline-content-wrapper .pp-post-timeline-item .pp-post-timeline-content .pp-post-timeline-meta a {
	<?php if ( $settings->meta_link_color ) { ?>color: <?php echo pp_get_color_value( $settings->meta_link_color ); ?>;<?php } ?>
}
...
.fl-node-<?php echo $id; ?> .pp-post-timeline-content-wrapper .pp-post-timeline-item .pp-post-timeline-content .pp-post-timeline-meta a:hover {
	<?php if ( $settings->meta_link_hover ) { ?>color: <?php echo pp_get_color_value( $settings->meta_link_hover ); ?>;<?php } ?>
}
...
.fl-node-<?php echo $id; ?> .pp-post-timeline-content-wrapper .pp-post-timeline-item .pp-post-timeline-content .pp-post-timeline-text-wrapper {
	<?php if ( $settings->content_color ) { ?>color: <?php echo pp_get_color_value( $settings->content_color ); ?>;<?php } ?>
...
.fl-node-<?php echo $id; ?> .pp-post-timeline.horizontal .pp-post-timeline-slide-navigation .pp-post-timeline-icon {
	...
	<?php } ?>
	border-color: <?php echo ( $settings->icon_border_color ) ? pp_get_color_value( $settings->icon_border_color ) : 'transparent'; ?>;
	...
	color: <?php echo ( $settings->icon_text_color ) ? pp_get_color_value( $settings->icon_text_color ) : '#000'; ?>;
...
.fl-node-<?php echo $id; ?> .pp-post-timeline.left .pp-post-timeline-content-wrapper .pp-post-timeline-item:nth-of-type(2n) .pp-separator-arrow {
	...
	<?php if ( isset( $settings->post_timeline_border['style'] ) && 'none' != $settings->post_timeline_border['style'] && isset( $settings->post_timeline_border['color'] ) && '' != $settings->post_timeline_border['color'] ) { ?>
		border-top-color: <?php echo pp_get_color_value( $settings->post_timeline_border['color'] ); ?>;
		border-left-color: <?php echo pp_get_color_value( $settings->post_timeline_border['color'] ); ?>;
...
.fl-node-<?php echo $id; ?> .pp-post-timeline.alternate .pp-post-timeline-content-wrapper .pp-post-timeline-item:nth-of-type(2n) .pp-separator-arrow {
	...
	<?php if ( isset( $settings->post_timeline_border['style'] ) && 'none' != $settings->post_timeline_border['style'] && isset( $settings->post_timeline_border['color'] ) && '' != $settings->post_timeline_border['color'] ) { ?>
		border-bottom-color: <?php echo pp_get_color_value( $settings->post_timeline_border['color'] ); ?>;
		border-right-color: <?php echo pp_get_color_value( $settings->post_timeline_border['color'] ); ?>;
	<?php } elseif ( isset( $settings->post_timeline_border['shadow'] ) && $settings->post_timeline_border['shadow']['color'] != '' ) { ?>
...
.fl-node-<?php echo $id; ?> .pp-post-timeline-content-wrapper .pp-post-timeline-item .pp-post-timeline-content .pp-post-timeline-button {
	...
	<?php } ?>
	<?php if ( $settings->post_timeline_button_text_color ) { ?>color: <?php echo pp_get_color_value( $settings->post_timeline_button_text_color ); ?>;<?php } ?>
...
.fl-node-<?php echo $id; ?> .pp-post-timeline-content-wrapper .pp-post-timeline-item .pp-post-timeline-content .pp-post-timeline-button:hover {
	...
	<?php } ?>
	<?php if ( $settings->post_timeline_button_text_hover ) { ?>color: <?php echo pp_get_color_value( $settings->post_timeline_button_text_hover ); ?>;<?php } ?>
}
...
.fl-node-<?php echo $id; ?> .pp-post-timeline-slide-navigation span.slick-arrow:hover {
	<?php if ( $settings->arrow_hover ) { ?>color: <?php echo pp_get_color_value( $settings->arrow_hover ); ?>;<?php } ?>
...
.fl-node-<?php echo $id; ?> .pp-post-timeline .slick-dots li button:before {
	<?php if ( $settings->dot_bg_color ) { ?>color: <?php echo pp_get_color_value( $settings->dot_bg_color ); ?>;<?php } ?>
...
.fl-node-<?php echo $id; ?> .pp-post-timeline .slick-dots li.slick-active button:before {
	<?php if ( $settings->dot_bg_hover ) { ?>color: <?php echo pp_get_color_value( $settings->dot_bg_hover ); ?>;<?php } ?>
}
