...
.fl-node-<?php echo $id; ?> .pp-infobox .pp-infobox-title-prefix {
	...
	display: none;
	<?php } ?>
	<?php if ( ! empty( $settings->title_prefix_color ) ) { ?>
	color: <?php echo pp_get_color_value( $settings->title_prefix_color ); ?>;
	<?php } ?>
	<?php if ( isset( $settings->title_prefix_margin['top'] ) && ! empty( $settings->title_prefix_margin['top'] ) ) { ?>
	margin-top: <?php echo $settings->title_prefix_margin['top']; ?>px;
	<?php } ?>
	<?php if ( isset( ( $settings->title_prefix_margin['bottom'] ) ) && ! empty( $settings->title_prefix_margin['bottom'] ) ) { ?>
	margin-bottom: <?php echo $settings->title_prefix_margin['bottom']; ?>px;
	<?php } ?>
}
<?php
...
.fl-node-<?php echo $id; ?> .pp-infobox-title-wrapper .pp-infobox-title {
	...
	<?php } ?>
	<?php if ( isset( $settings->title_margin['top'] ) && '' !== $settings->title_margin['top'] ) { ?>
	margin-top: <?php echo $settings->title_margin['top']; ?>px;
	<?php } ?>
	<?php if ( isset( $settings->title_margin['bottom'] ) && '' !== $settings->title_margin['bottom'] ) { ?>
...
.fl-node-<?php echo $id; ?> .pp-infobox-description {
	...
	<?php } ?>
	<?php if ( isset( $settings->text_margin['top'] ) && ! empty( $settings->text_margin['top'] ) ) { ?>
	margin-top: <?php echo $settings->text_margin['top']; ?>px;
	<?php } ?>
	<?php if ( isset( $settings->text_margin['bottom'] ) && ! empty( $settings->text_margin['bottom'] ) ) { ?>
...
<?php if( $settings->icon_type == 'image' ) { ?>
	...
	.fl-builder-content .fl-node-<?php echo $id; ?> .pp-infobox-image img {
		height: auto;
		<?php if ( $settings->image_width_type == 'default' ) { ?>
			width: auto;
		<?php } ?>
		max-width: 100%;
		<?php if ( '' !== $settings->icon_box_size ) { ?>
...
.fl-node-<?php echo $id; ?> .pp-infobox-wrap .pp-infobox {
	<?php if ( ! empty( $settings->box_background ) ) { ?>
		background: <?php echo pp_get_color_value( $settings->box_background ); ?>;
	<?php } ?>
	<?php if ( ! empty( $settings->alignment ) ) { ?>
		text-align: <?php echo $settings->alignment; ?>;
	<?php } ?>
}
...
.fl-node-<?php echo $id; ?> .pp-infobox:hover {
	<?php if ( ! empty( $settings->box_background_hover ) ) { ?>
...
<?php if( $settings->pp_infobox_link_type == 'read_more' || $has_button ) { ?>
	.fl-node-<?php echo $id; ?> .pp-infobox .pp-more-link {
		<?php if ( ! empty( $settings->pp_infobox_read_more_color ) ) { ?>
			color: <?php echo pp_get_color_value( $settings->pp_infobox_read_more_color ); ?>;
		<?php } ?>
		<?php if ( $has_button && ! empty( $settings->button_bg_color ) ) { ?>
	...
	.fl-node-<?php echo $id; ?> .pp-infobox .pp-more-link:hover {
		<?php if ( ! empty( $settings->pp_infobox_read_more_color_hover ) ) { ?>
			color: <?php echo pp_get_color_value( $settings->pp_infobox_read_more_color_hover ); ?>;
		<?php } ?>
		<?php if ( $has_button && ! empty( $settings->button_bg_hover_color ) ) { ?>
	...
	<?php } ?>
	<?php if ( ! empty( $settings->button_icon_color_hover ) ) { ?>
	...
	<?php } ?>
	<?php if ( '' !== $settings->button_icon_spacing ) { ?>
...
<?php if ( '' !== $settings->animation_duration ) { ?>
.fl-node-<?php echo $id; ?> .pp-infobox .animated {
	-webkit-animation-duration: <?php echo $settings->animation_duration; ?>ms;
	-moz-animation-duration: <?php echo $settings->animation_duration; ?>ms;
	-o-animation-duration: <?php echo $settings->animation_duration; ?>ms;
	-ms-animation-duration: <?php echo $settings->animation_duration; ?>ms;
	animation-duration: <?php echo $settings->animation_duration; ?>ms;
}
<?php } ?>
