...
class PPFilterableGalleryModule extends FLBuilderModule {
	...
	public function get_click_action_link( $photo ) {
		$click_action = $this->settings->click_action;
		$click_action_link = 'javascript:void(0)';

		if ( $click_action == 'custom-link' ) {
			if ( ! empty( $photo->cta_link ) ) {
				$click_action_link = esc_url( $photo->cta_link );
			}
		}

		if ( $click_action == 'lightbox' ) {
			$click_action_link = esc_url( $photo->link );
		}

		return $click_action_link;
	}
            ...
            'general'       => array( // Section
                ...
                'fields'        => array( // Section Fields
					...
					'show_captions' => array(
						...
						'toggle'	=> array(
							'below'	=> array(
								'fields'	=> array('caption_bg_color', 'caption_alignment')
							),
						),
			...
			'pagination_style' => array(
				...
				'fields' => array(
					'pagination_typography' => array(
						...
						'preview'    => array(
							'type'     => 'css',
							'selector' => '.pp-filterable-gallery-pagination',
						),
					),
					...
					'pagination_bg_color' => array(
						...
						'preview'     => array(
							'type'     => 'css',
							'selector' => '.pp-filterable-gallery-pagination a',
							'property' => 'background-color'
						),
					),
					'pagination_bg_hover_color' => array(
						...
						'preview'     => array(
							'type'     => 'css',
							'selector' => '.pp-filterable-gallery-pagination a:hover',
							'property' => 'background-color'
						),
					),
