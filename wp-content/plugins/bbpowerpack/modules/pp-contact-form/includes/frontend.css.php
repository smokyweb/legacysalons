...
FLBuilderCSS::typography_field_rule( array(
	...
	'selector' 		=> ".fl-builder-content .fl-node-$id .pp-contact-form .fl-button,
						.fl-builder-content .fl-node-$id .pp-contact-form .fl-button:visited",
) );
// Label Font
...
.fl-builder-content .fl-node-<?php echo $id; ?> .pp-contact-form .fl-button:visited {
	...
	border: <?php echo $border_size; ?>px <?php echo $border_style; ?> <?php echo pp_get_color_value( $border_color ); ?>;

	<?php if ( ! empty( $settings->btn_bg_color ) ) : ?>
		background: <?php echo pp_get_color_value( $settings->btn_bg_color ); ?>;

		<?php if ( 'transparent' == $settings->btn_style ) : // Transparent ?>
		background-color: <?php echo pp_hex2rgba( pp_get_color_value( $settings->btn_bg_color ), $settings->btn_bg_opacity ); ?>;
		<?php endif; ?>

		<?php if( 'gradient' == $settings->btn_style ) : // Gradient ?>
		background: -moz-linear-gradient(top, <?php echo pp_get_color_value( $bg_grad_start ); ?> 0%, <?php echo pp_get_color_value( $settings->btn_bg_color ); ?> 100%); /* FF3.6+ */
		background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,<?php echo pp_get_color_value( $bg_grad_start ); ?>), color-stop(100%,<?php echo pp_get_color_value( $settings->btn_bg_color ); ?>)); /* Chrome,Safari4+ */
		background: -webkit-linear-gradient(top, <?php echo pp_get_color_value( $bg_grad_start ); ?> 0%,<?php echo pp_get_color_value( $settings->btn_bg_color ); ?> 100%); /* Chrome10+,Safari5.1+ */
		background: -o-linear-gradient(top, <?php echo pp_get_color_value( $bg_grad_start ); ?> 0%,<?php echo pp_get_color_value( $settings->btn_bg_color ); ?> 100%); /* Opera 11.10+ */
		background: -ms-linear-gradient(top, <?php echo pp_get_color_value( $bg_grad_start ); ?> 0%,<?php echo pp_get_color_value( $settings->btn_bg_color ); ?> 100%); /* IE10+ */
		background: linear-gradient(to bottom, <?php echo pp_get_color_value( $bg_grad_start ); ?> 0%,<?php echo pp_get_color_value( $settings->btn_bg_color ); ?> 100%); /* W3C */
		filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='<?php echo pp_get_color_value( $bg_grad_start ); ?>', endColorstr='<?php echo pp_get_color_value( $settings->btn_bg_color ); ?>',GradientType=0 ); /* IE6-9 */
		<?php endif; ?>
...
.fl-builder-content .fl-node-<?php echo $id; ?> .fl-button *,
.fl-builder-content .fl-node-<?php echo $id; ?> .fl-button:visited * {
	color: <?php echo pp_get_color_value( $settings->btn_text_color ); ?>;
}
<?php endif; ?>
...
.fl-builder-content .fl-node-<?php echo $id; ?> .fl-button:focus {
	...
	border: <?php echo $border_size; ?>px <?php echo $border_style; ?> <?php echo pp_get_color_value( $border_hover_color ); ?>;
}
<?php endif; ?>
...
.fl-builder-content .fl-node-<?php echo $id; ?> .fl-button:focus {
	...
	background: <?php echo pp_get_color_value( $settings->btn_bg_hover_color ); ?>;

	<?php if ( 'transparent' == $settings->btn_style ) : // Transparent ?>
	background-color: <?php echo pp_hex2rgba( pp_get_color_value( $settings->btn_bg_hover_color ), $settings->btn_bg_hover_opacity ); ?>;
	border: <?php echo $border_size; ?>px <?php echo $border_style; ?> <?php echo pp_get_color_value( $settings->btn_bg_hover_color ); ?>;
	<?php endif; ?>

	<?php if ( 'gradient' == $settings->btn_style ) : // Gradient ?>
	background: -moz-linear-gradient(top,  <?php echo pp_get_color_value( $bg_hover_grad_start ); ?> 0%, <?php echo pp_get_color_value( $settings->btn_bg_hover_color ); ?> 100%); /* FF3.6+ */
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,<?php echo pp_get_color_value( $bg_hover_grad_start ); ?>), color-stop(100%,<?php echo pp_get_color_value( $settings->btn_bg_hover_color ); ?>)); /* Chrome,Safari4+ */
	background: -webkit-linear-gradient(top,  <?php echo pp_get_color_value( $bg_hover_grad_start ); ?> 0%,<?php echo pp_get_color_value( $settings->btn_bg_hover_color ); ?> 100%); /* Chrome10+,Safari5.1+ */
	background: -o-linear-gradient(top,  <?php echo pp_get_color_value( $bg_hover_grad_start ); ?> 0%,<?php echo pp_get_color_value( $settings->btn_bg_hover_color ); ?> 100%); /* Opera 11.10+ */
	background: -ms-linear-gradient(top,  <?php echo pp_get_color_value( $bg_hover_grad_start ); ?> 0%,<?php echo pp_get_color_value( $settings->btn_bg_hover_color ); ?> 100%); /* IE10+ */
	background: linear-gradient(to bottom,  <?php echo pp_get_color_value( $bg_hover_grad_start ); ?> 0%,<?php echo pp_get_color_value( $settings->btn_bg_hover_color ); ?> 100%); /* W3C */
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='<?php echo pp_get_color_value( $bg_hover_grad_start ); ?>', endColorstr='<?php echo pp_get_color_value( $settings->btn_bg_hover_color ); ?>',GradientType=0 ); /* IE6-9 */
	<?php endif; ?>
}
<?php endif; ?>
...
.fl-builder-content .fl-node-<?php echo $id; ?> .fl-button:hover *,
.fl-builder-content .fl-node-<?php echo $id; ?> .fl-button:focus * {
	color: <?php echo pp_get_color_value( $settings->btn_text_hover_color ); ?>;
}
<?php endif; ?>
...
.fl-node-<?php echo $id; ?> .pp-contact-form .pp-checkbox label {
	<?php if ( isset( $settings->checkbox_color ) && ! empty( $settings->checkbox_color ) ) { ?>
		color: <?php echo pp_get_color_value( $settings->checkbox_color ); ?>;
    <?php } ?>
}
...
.fl-node-<?php echo $id; ?> .pp-contact-form .pp-error input[type=email] {
	<?php if ( ! empty( $settings->validation_field_border_color ) ) { ?>
		border-color: <?php echo pp_get_color_value( $settings->validation_field_border_color ); ?>;
    <?php } ?>
}
