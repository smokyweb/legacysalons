...
.fl-node-<?php echo $id; ?> .pp-fluent-form-content .fluentform .ff-el-form-check-label {
	...
	color: <?php echo pp_get_color_value( $settings->label_color ); ?>;
	<?php } ?>
	<?php if ( is_array( $settings->label_typography ) && isset( $settings->label_typography['font_family'] ) && 'Default' !== $settings->label_typography['font_family'] ) { ?>
...
.fl-node-<?php echo $id; ?> .pp-fluent-form-content .ff-el-section-break {
	...
	color: <?php echo pp_get_color_value( $settings->section_description_color ); ?>;
	<?php } ?>
}

.fl-node-<?php echo $id; ?> .pp-fluent-form-content .ff-el-section-break .ff-el-section-title {
	<?php if ( $settings->section_title_color ) { ?>
	color: <?php echo pp_get_color_value( $settings->section_title_color ); ?>;
	<?php } ?>
}
...
.fl-node-<?php echo $id; ?> .pp-fluent-form-content .ff-el-is-error .error {
	...
	color: <?php echo pp_get_color_value( $settings->error_message_color ); ?>;
	<?php } ?>
}
...
.fl-node-<?php echo $id; ?> .pp-fluent-form-content .ff-el-is-error .ff-el-form-control {
	...
	border-style: solid;
	border-color: <?php echo pp_get_color_value( $settings->error_input_field_border_color ); ?>;
