  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-slate-900 to-blue-900 flex-col items-center justify-center p-12 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 w-48 h-48 bg-violet-600/10 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '4s' }} />

        <div className="absolute top-16 left-10 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-4 w-48 rotate-[-8deg]">
          <div className="flex items-center gap-2 mb-2">
            <div className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
            <span className="text-white/80 text-xs font-medium">AI Active</span>
          </div>
          <p className="text-white text-sm font-semibold">5 bookings today</p>
          <p className="text-white/60 text-xs">via AI Receptionist</p>
        </div>

        <div className="absolute bottom-20 right-10 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-4 w-44 rotate-[6deg]">
          <p className="text-white/60 text-xs mb-1">Revenue this week</p>
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-slate-400 text-lg max-w-sm mx-auto">
            Join 300,000+ beauty professionals automating their bookings.
          </p>
          <div className="flex items-center justify-center gap-8 mt-10">
            {[{ value: '300K+', label: 'Pros' }, { value: '162M+', label: 'Bookings' }, { value: '4.9★', label: 'Rating' }].map(({ value, label }) => (
              <div key={label} className="text-center">
                <p className="text-xl font-black bg-gradient-to-r from-blue-400 to-pink-400 bg-clip-text text-transparent">{value}</p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl border border-gray-200 text-slate-700 text-sm font-medium hover:bg-gray-50 transition-all">
