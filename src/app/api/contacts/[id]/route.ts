...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  const db = getDb()
  const fields = ['first_name','last_name','email','phone','company','stage','notes','assigned_to','deal_value','last_contacted','likely_move_date','budget','speciality','lead_source','lead_date']
